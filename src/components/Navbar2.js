    ...
    render() {
        ...
        return (
            <div>
                ...
                <div className='d-flex flex-col-auto min-vh-100 d-inline h-100' >
                    {this.props.auth.uid ?
                    <SideNav className='bg-dark   position-relative' >
                        <SideNav.Toggle ></SideNav.Toggle>
                        <SideNav.Nav >
                        { this.props.accData ?this.props.accData.type == "admin"?
                            <NavItem   onClick={this.notify}>
                                <NavIcon>
                                    <i className="fa fa-plus" style={{ fontSize: '1.75em' }} />
                                </NavIcon>
                                <NavText>
                                    {i18next.t('PushNotifications')}
                                </NavText>
                            </NavItem>:null:null}
                            <NavItem  onClick={(e)=>{e.preventDefault(); this.setState({shownoti:true})}}>
                                <NavIcon>
                                    <i className='fa fa-bell' style={{ fontSize: '1.75em' }} />
                                </NavIcon>
                                <NavText>
                                    {i18next.t('Notifications')}  <span className="badge badge-secondary">{this.props.number?this.props.number :0}</span>                                </NavText>
                            </NavItem>
                            <NavItem onClick={(e)=>{e.preventDefault(); this.setState({account:true})}}>
                                <NavIcon>
                            ...
                            <NavItem  onClick={ (e)=>{e.preventDefault(); this.props.signOut()}}>
                                <NavIcon>
